...
// musicBackgroundGetNightTrack is implemented in functions_sound.cpp
...
void Functions::popUpGUIPanel(Aurora::NWScript::FunctionContext &ctx) {
	...
	debugC(Common::kDebugEngineLogic, 1, "PopUpGUIPanel: %d", panel);
